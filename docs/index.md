# Linux UIP — Documentation d’Exploitation Production
...
<details>
<summary><strong>2. Exécution opérationnelle</strong></summary>

- [Commandes d’exécution](execution.md)
- [Tags transverses](tags.md)
- [Mode Breakglass et fenêtres de changement](governance.md)
...
- [Postcheck](role-postcheck.md)
- [Rollback](role-rollback.md)

</details>

<details>
<summary><strong>4. CI / Qualité / Production</strong></summary>

- [CI GitHub Actions](ci.md)
- [Rapports et exploitation](reports.md)
